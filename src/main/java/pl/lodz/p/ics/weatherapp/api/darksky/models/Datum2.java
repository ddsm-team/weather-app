...
public class Datum2 {
    ...
    public Datum2(Integer time, String summary, String icon, Integer sunriseTime,
                  Integer sunsetTime, Double moonPhase, Double precipIntensity,
                  Double precipIntensityMax, Integer precipIntensityMaxTime,
                  Double precipProbability, String precipType, Double temperatureMin,
                  Integer temperatureMinTime, Double temperatureMax,
                  Integer temperatureMaxTime, Double apparentTemperatureMin,
                  Integer apparentTemperatureMinTime, Double apparentTemperatureMax,
                  Integer apparentTemperatureMaxTime, Double dewPoint, Double humidity,
                  Double windSpeed, Integer windBearing, Double visibility,
